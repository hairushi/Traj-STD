...
from one_stage_syngan_model_location import syngan
from two_stage_predgan_model_location import predgan
...
def main(args):
    ...
    predicted_data_to_txt_pic = list(result_traj)
    #predicted_data_with_time_to_txt_pic = list(result_traj_with_time)
    ...
    out_path_txt = data_output + 'formalized_txt_syn' + str(args.cut_seq_len) + '_pred' + str(args.pred_seq_len) + \
                   '_min' + str(min_len) + '_max' + str(max_len) + '_5.txt'
    ...
    #     args.pred_seq_len) + \
    #                          '_min' + str(min_len) + '_max' + str(max_len) + '_with_time_1.txt'
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--dataset_path',
        # default="./data/porto_2w_iter120_b5.txt",
        default="/hy-tmp/data/porto_2w_iter120_b5.txt",
        #default="./data/porto_grid20_boundary4_sample_5000.txt",
        type=str)
    parser.add_argument(
        '--out_data_path',
        # default='./4_22_geo_grid6_final/syn_5_pred_4/',
        # default='./test/syn_9_pred_1/',
        default='/hy-tmp/5_16_gen_result_porto_2w_iter120_b5/',
        type=str)
    parser.add_argument(
        '--cell_num',
        # default=6,
